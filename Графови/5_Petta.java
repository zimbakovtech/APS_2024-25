...
public class Main {
    ...
    static int pathsOfWeightN(AdjacencyListGraph<Integer> graph, int vertex, int goalWeight, int currentWeight) {
        ...
        for (int neighbor : graph.getNeighbors(vertex))
            totalPaths += pathsOfWeightN(graph, neighbor, goalWeight, currentWeight + neighbor);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(pathsOfWeightN(graph, start, length, start));
    }
}